...
;;nrepl config : Need to put them somewhere else
...
(global-set-key (kbd "C-L" ) 'slime-repl-clear-buffer)  ;to clear repl buffer in slime mode [C-L]

(set-face-attribute 'default nil :height 110)


;;It will auto refresh a file if changed
